    ...
    <div><!-- ---------------------------------- -->
        ...
        <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="#" class="text-nowrap logo-img">
                ...
                <?php if($settings->logo == 'N/A'): ?>
                    <img src="<?php echo e(asset('backend/dist/assets/images/logos/dark-logo.svg')); ?>" class="dark-logo" alt="Logo-Dark" />
                    <img src="<?php echo e(asset('backend/dist/assets/images/logos/light-logo.svg')); ?>" class="light-logo" alt="Logo-light" />
                <?php else: ?>
                    <img src="<?php echo e(asset('storage/uploads/logo/' . $settings->logo)); ?>" class="dark-logo"
                        alt="Logo-Dark" />
                    <img src="<?php echo e(asset('storage/uploads/logo/' . $settings->logo)); ?>" class="light-logo"
                        alt="Logo-light" />
                <?php endif; ?>
            </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="<?php echo e(route('dashboard.setting.index')); ?>" aria-expanded="false">
                        <span>
...
<?php /**PATH C:\Joki\sistem-manajemen-tugas\resources\views/layouts/backend/sidebar.blade.php ENDPATH**/ ?>