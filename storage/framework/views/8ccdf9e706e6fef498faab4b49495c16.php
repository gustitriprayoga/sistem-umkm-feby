        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex align-items-center mb-7 pb-2">
                    <div class="me-3 pe-1">
                        <img src="backend/dist/assets/images/profile/user-2.jpg"
                ...
                <div class="d-flex justify-content-between">
                    <ul class="hstack mb-0">
                        ...
                        <li class="ms-n8">
                            <a href="javascript:void(0)" class="me-1">
                                <img src="backend/dist/assets/images/profile/user-3.jpg"
                                    class="rounded-circle border border-2 border-white"
                                    width="44" height="44" alt="modernize-img" />
                            </a>
                        </li>
                        <li class="ms-n8">
                            <a href="javascript:void(0)" class="me-1">
                                <img src="backend/dist/assets/images/profile/user-4.jpg"
                                    class="rounded-circle border border-2 border-white"
                                    width="44" height="44" alt="modernize-img" />
                            </a>
                        </li>
                        <li class="ms-n8">
                            <a href="javascript:void(0)" class="me-1">
                                <img src="backend/dist/assets/images/profile/user-5.jpg"
                                    class="rounded-circle border border-2 border-white"
                                    width="44" height="44" alt="modernize-img" />
                            </a>
                        </li>
        ...
        <div class="card text-bg-primary border-0 w-100">
            <div class="card-body pb-0">
                ...
                <div class="text-center mt-3">
                    <img src="backend/dist/assets/images/backgrounds/piggy.png"
                        class="img-fluid" alt="modernize-img" />
                </div>
            </div>
                        ...
                        <tbody class="border-top">
                            ...
                            <tr>
                                <td class="ps-0">
                                    <div class="d-flex align-items-center">
                                        <div class="me-2 pe-1">
                                            <img src="backend/dist/assets/images/profile/user-6.jpg"
                                                class="rounded-circle" width="40"
                                                height="40" alt="modernize-img" />
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td class="ps-0">
                                    <div class="d-flex align-items-center">
                                        <div class="me-2 pe-1">
                                            <img src="backend/dist/assets/images/profile/user-7.jpg"
                                                class="rounded-circle" width="40"
                                                height="40" alt="modernize-img" />
                                        </div>
                                        <div>
                            ...
                            <tr>
                                <td class="border-0 ps-0">
                                    <div class="d-flex align-items-center">
                                        <div class="me-2 pe-1">
                                            <img src="backend/dist/assets/images/profile/user-8.jpg"
                                                class="rounded-circle" width="40"
                                                height="40" alt="modernize-img" />
                                        </div>
                                        <div>
...
<?php echo $__env->make('layouts.backend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Joki\sistem-manajemen-tugas\resources\views/backend/dashboard/index.blade.php ENDPATH**/ ?>